...
NUM_FEATS = ['regular_price','discounted_price','no_stores','holiday']



ALFA = Pipeline([('days',dayName()),('praznici',holiday()),('features', DFFeatureUnion([('numerics', Pipeline([
...
BETA = Pipeline([('days',dayName()),('praznici',holiday()),('features', DFFeatureUnion([('numerics', Pipeline([
            ('extract', ColumnExtractor(NUM_FEATS)),
            ('zero_fill', ZeroFillTransformer())
            ])),('categoricals', Pipeline([('extract', ColumnExtractor(CAT_FEATS)),
                                           ('dummy', DummyTransformer())]))])),('opop',DFStandardScaler()),('classifier', LinearRegression())])

GAMA = Pipeline([('days',dayName()),('praznici',holiday()),('features', DFFeatureUnion([('numerics', Pipeline([
            ('extract', ColumnExtractor(NUM_FEATS)),
            ('zero_fill', ZeroFillTransformer())
            ])),('categoricals', Pipeline([('extract', ColumnExtractor(CAT_FEATS)),
                                           ('dummy', DummyTransformer())]))])),('classifier', LinearRegression())])

DELTA = Pipeline([('days',dayName()),('praznici',holiday()),('features', DFFeatureUnion([('numerics', Pipeline([
            ('extract', ColumnExtractor(NUM_FEATS)),
            ('zero_fill', ZeroFillTransformer()),('opop',DFStandardScaler())
            ])),('categoricals', Pipeline([('extract', ColumnExtractor(CAT_FEATS)),
                                           ('dummy', DummyTransformer())]))])),('classifier', LinearRegression())])
